...
```bash
npm view codex-pet-companion@0.3.1 version dist-tags repository license
npm pack codex-pet-companion@0.3.1 --dry-run

workdir="$(mktemp -d)"
cd "$workdir"
npm init -y
npm install codex-pet-companion@0.3.1
...
- `https://unpkg.com/codex-pet-companion@0.3.1/dist/codex-pet-companion.global.js`
- `https://cdn.jsdelivr.net/npm/codex-pet-companion@0.3.1/dist/codex-pet-companion.global.js`
